...
class KGEModel(nn.Module):
    def __init__(self, model_name, nentity, nrelation, hidden_dim, gamma,
        ...
        self.infE = nn.Parameter(np.load('models/TestE_wn18rr_test/entity_embedding.npy'))
        self.infR = nn.Parameter(np.load('models/TestE_wn18rr_test/relation_embedding.npy'))
