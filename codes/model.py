...
class KGEModel(nn.Module):
    def __init__(self, model_name, nentity, nrelation, hidden_dim, gamma, 
        ...
        self.epsilon = 2.0
        self.m_weight = nn.Parameter(torch.Tensor([[0.05]]))
    ...
    def OpticalE_dir_ampone(self, head, relation, tail, mode):
        ...
        # print(var.mean())
        intensity = F.softmax(intensity * 0.5, dim=2).detach() * intensity * self.hidden_dim



        score = self.gamma.item() - intensity.sum(dim=2) * 0.0075
