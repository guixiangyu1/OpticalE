...
class KGEModel(nn.Module):
    def __init__(self, model_name, nentity, nrelation, hidden_dim, gamma, 
        ...
        if model_name == 'pRotatE' or model_name == 'rOpticalE_mult' or model_name == 'OpticalE_symmetric' or \
                ...
                model_name=='TransE_less' or model_name=='TestE1' or model_name=='OpticalE_pretrain':
        ...
        if model_name not in ['TransE', 'DistMult', 'ComplEx', 'RotatE', 'pRotatE', 'OpticalE', 'rOpticalE', 'HopticalE_add', \
                              ...
                              'TransE_less', 'LinearE', 'TestE1', 'OpticalE_pretrain']:
    ...
    def forward(self, sample, mode='single'):
        ...
        model_func = {
            ...
            'OpticalE_pretrain': self.OpticalE_pretrain,
    ...
    def OpticalE_pretrain(self, head, relation, tail, mode):
        ...
        score = self.gamma.item() - inference.sum(dim=2) * 0.015
    ...
    def train_step(model, optimizer, train_iterator, args):
        ...
        loss = (positive_sample_loss + 0.5 * negative_sample_loss)/2
