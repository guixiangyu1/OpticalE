...
class KGEModel(nn.Module):
    def __init__(self, model_name, nentity, nrelation, hidden_dim, gamma, 
        ...
        if model_name not in ['TransE', 'DistMult', 'ComplEx', 'RotatE', 'pRotatE', 'OpticalE', 'rOpticalE', \
                              ...
                              'OpticalE_intefere', 'OpticalE_interference_term', 'HopticalE', 'HopticalE_re', 'regOpticalE', 'regOpticalE_r', 'HopticalE_add']:
    ...
    def regOpticalE_r(self, head, relation, tail, mode):
        ...
        score = 3 * (tail_mod ** 2 + head_mod ** 2 + rel_mod ** 2) + 2 * torch.abs(head_mod * rel_mod +  head_mod * tail_mod + rel_mod * tail_mod) * torch.cos(head_phase + rel_phase - tail_phase)
